...
import sliceManager from "./components/util/sliceManager";
      ...
      <BrowserRouter>
        <div className="App">
          ...
          <Switch>
            ...
            <Route exact path="/createSlice" component={CreateSlice} />
            <Route exact path="/createClass" component={CreateClass} />
            <Route exact path="/manage/slices/:id" component={sliceManager} />
            <Route exact path="/sessionplans" component={SessionPlans} />
            <Route exact push path="/sessionplans/:id" component={PlanSession} />

...
function sendResponseToDB(studentId, response, timesPolled, session, slice) { //Check both methods
    ...
    let setDoc = db.collection('piesiue/responses').doc(docName).set(data);

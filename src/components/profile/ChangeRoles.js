        ...
        return (
            <div className="container section">
                <form onSubmit={this.handleSubmit} className="white">
                    <h2 className="grey-text text-darken-3" style={{ textAlign: "center" }}>Change User Roles</h2>
                    ...
                    <div className="input-field">
                        <button type="submit" className="btn waves-effect waves-light purple-bg purple darken-3 z-depth-1">Change</button>
                    </div>
                    {roleError ? <div className="red-text center text-darken-1"><p>{roleError}</p></div> : null}
                </form>
            </div>
        );
    }

                            ...
                            <div className="flexbox">
                                ...
                                {(user.userRole === "admin" || user.userRole === "instructor") ?
                                    <Link to={'/session/' + classs.currSession + '/projection/'} key={classs.currSession} >
                                        <div className="col mar1"><button type="button" className="btn red-bg red darken-3 z-depth-1 waves-effect waves-light">Projection</button></div>
                                    </Link>
                                    : null}

                                {(user.userRole === "admin" || user.userRole === "instructor") ?
                                    <Link to={'/session/' + classs.currSession + '/presentation/'} key={classs.currSession} >
                                        <div className="col mar1"><button type="button" className="btn red-bg red darken-3 z-depth-1 waves-effect waves-light">Presentation</button></div>
                                    </Link>
                                    : null}

                ...
                {formMode ? (
                  <Row className="class-message">
                    <Textarea
                      ...
                      defaultValue={classs.messageOfTheDay}
                      s={12}
                      m={12}
                      l={12}
                      xl={12}
                  ...
                  <p className="class-message">{classs.messageOfTheDay}</p>
                )}
              </div>
              <div className="card-action grey lighten-4 grey-text">
                <div>
                  Teacher: {classs.teacherFirstName} {classs.teacherLastName}
                </div>
        ...
        <div>
          <div className="container section classs-details">
            ...
            <div className="row">
              <div className="flexbox">
                <div className="col mar1">
                  <Modal
                    ...
                    actions={
                      <Button waves="purple" modal="close" flat>
                        Okay
                      </Button>
                    }
                    header="No Session Active"
                    trigger={
                      <button data-target="modal1" className={buttonClassName}>
                        Join Session
                      </button>
                    }
                  >
              ...
              {loadingError ? (
                <div className="center red-text error-msg center text-darken-1">
                  <p>{loadingError}</p>
                </div>
              ) : null}
            </div>

...
class ProjectionTemplate extends Component {
	...
	render() {
		...
		let nameStyle = { cursor: "default", float: "right", position: "absolute", color: "black", bottom: "2%", left: "114.5%", fontSize: "12px" };
		...
		return (
			...
			>
				...
				<div id="body" className="presentation_body class-message">
					{this.props.url ? (
						<img
							style={{ position: "absolute", top: "0px", left: "0px", right: "0px", width: "100%", height: "100%" }}
							alt=""
							src={this.props.url}
						/>
					) : this.props.question ? (
